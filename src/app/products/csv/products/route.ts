import { buildAttachmentContentDisposition, productStockCsvFile } from "@/lib/downloadFileNames";
...
export async function GET(req: Request) {
  ...
  return new Response(csv, {
    headers: {
      ...
      "Content-Disposition": buildAttachmentContentDisposition(productStockCsvFile()),
