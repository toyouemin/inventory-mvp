  ...
  if (row.isListNoVisibleOptionsRow) {
    return (
      <tr className="products-table__tr-novis">
        ...
        <td className="products-table__td-tight products-table__td-novis-msg">재고 없음</td>
...
export function ProductsClient({
  ...
  useEffect(() => {
    ...
    const offset = Math.round(headerH * 0.5) + 80;
    const absoluteTop = window.scrollY + target.getBoundingClientRect().top;
    const y = Math.max(0, absoluteTop - offset);
